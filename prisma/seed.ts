...
async function main() {
  ...
  const sessions = [
    ...
    },
    {
      ...
      description: 'Hvordan jeg bygget min Hermes, og hva det gjør med måten jeg jobber på.',
    },
    {
    ...
    },
    {
      ...
      description: 'Er det ikke litt rart at alle produkter og tjenester vi lager ikke er jævlig bra? Når kan metodikk være nyttig og hva er det metodikk IKKE løser? Kritisk tenkning & faglig dømmekraft har aldri vært viktigere.',
    },
    {
      ...
      startTime: new Date('2026-06-11T10:45:00'),
      endTime: new Date('2026-06-11T11:15:00'),
      description: 'I dette innlegget deler Kjetil fra egen hverdag der meesteparten av koden nå genereres av AI, og diskuterer balansen mellom produktivitet og kvalitet.',
    },
    {
      ...
      description: 'Mange team utvikler løsninger, færre får rom til å skape reell verdi. Knut, Therese og Janne deler erfaring fra SPK om hvordan tverrfaglige produktteam, riktige styringsrammer og gode designprosesser kan gi mer samfunnsnytte.',
    },
    {
      title: 'Luuuuuunsj',
      speaker: null,
    ...
    },
    {
      ...
      description: 'Jawad sitter som direktør for AI & Cloud hos Telenor Group. Hans arbeid er rundt hvordan AI kan transformere brukeropplevelse, forbedre nettverkintelligense og drive med smart produktutvikling.',
    },
    {
    ...
    },
    {
      ...
      startTime: new Date('2026-06-11T14:20:00'),
      endTime: new Date('2026-06-11T14:50:00'),
      description: 'We are going hardcore with using AI to get developers to care about UX',
    },
    {
      title: 'Pause',
      speaker: null,
    ...
    },
    {
      ...
      description: 'Alle ønsker mer samhold , mer fellesskapsfølelse, mer team ; men hvordan skapes den gode følelsen av å høre til?',
    },
    {
      title: 'Avslutning',
      speaker: 'Solveig',
    ...
    },
    {
      ...
      description: 'Vi møter opp tilbake på Vulkanarena og spiser middag på scenen 2.etg',
    },
